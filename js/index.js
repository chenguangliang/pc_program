...
(function () {
    ...
    for (var i = 0; i < list.length; i++) {
        ...
        curList.onmouseout = function () {
            ...
            utils.css(listCont[this.index], 'border-right', '1px solid #e6e6e6');
        }
    }
})();
//右边fix滑过出现
(function () {
    ...
    side.addEventListener("mouseover", function () {
        cglAnimate(sideNav, {right: 0}, 200);
    }, false);
    side.addEventListener("mouseout", function () {
        cglAnimate(sideNav, {right: -38}, 200);
    }, false);
    //var body = document.body;
    //body.addEventListener("mouseenter", function (e) {
    //    e=e||window.event;
    //    if(e.clientX<document.body.clientWidth&&e.clientX>(document.body.clientWidth-38)){
    //        console.log(1);
    //        cglAnimate(sideNav, {right: 0}, 200);
    //    }
    //}, false);
    ...
    window.onscroll = function () {
        ...
        toTop.onclick = function () {
            document.body.scrollTop = 0;
             //cglAnimate(document.body,{scrollTop:0},500);
        }
